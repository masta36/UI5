sap.ui.define([
	"sap/ui/test/Opa5",
	"com/pr36/pic/test/integration/pages/Common"
		...
		onTheBrowserPage: {
			...
			actions: {
				...
				iChangeTheHashToTheRememberedItem: function() {
					return this.waitFor({
						success: function() {
							var sObjectId = this.getContext().currentListItem.getBindingContext().getProperty("OrderID");
				...
				iShouldSeeTheHashForObjectN: function(iObjIndex) {
					return this.waitFor(this.createAWaitForAnEntitySet({
						...
						success: function(aEntitySet) {
							...
							QUnit.strictEqual(sHash, "Orders/" + aEntitySet[iObjIndex].OrderID, "The Hash is not correct");
						}
					}));
				},
					...
					return this.waitFor({
						success: function() {
							var sObjectId = this.getContext().currentListItem.getBindingContext().getProperty("OrderID"),
								...
								sHash = oHashChanger.getHash();
							QUnit.strictEqual(sHash, "Orders/" + sObjectId, "The Hash is not correct");
						}
					});
				},
